...
export default function Hangman() {
  ...
  return (
    <div className="bg-black border border-green-400 text-green-400 font-mono p-4 rounded h-[500px] max-w-xl lg:mx-auto mx-5 lg:mt-36 mt-24 shadow-lg flex flex-col">
