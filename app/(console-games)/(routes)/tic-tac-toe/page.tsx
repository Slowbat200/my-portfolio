...
export default function TicTacToe() {
  ...
  return (
    <div className='dark:bg-black bg-white border border-blue-400 text-blue-300 font-mono p-4 rounded h-[500px] max-w-xl mx-auto mt-36 shadow-lg flex flex-col items-center'>
